...
/**
 * Example of Whirpool consumer to be used by Product Avatar in Nimble
 * @author a.musumeci
 */
@Path("/whirpool")
public class WhirpoolRestService extends CustomRestService {
    ...
    public Response getProductionData(@PathParam("login") String login, @PathParam("password") String password, @PathParam("serialnumber") String serialnumber) { 
        return super.getFilteredMessageForSubscription( login,  password,  "IT_WHIRPOOL_STREAMS_DC_PRODUCTIONDATA", "serialnumber='"+serialnumber+"'");
    }
    ...
    public Response getQualityData(@PathParam("login") String login, @PathParam("password") String password, @PathParam("serialnumber") String serialnumber) { 
        return super.getFilteredMessageForSubscription( login,  password,  "IT_WHIRPOOL_STREAMS_DC_QUALITYDATA", "serialnumber='"+serialnumber+"'");
    }
     ...
     */
    @GET
    @Path("/customerData/{login}/{password}/{serialnumber}")
    @Produces(MediaType.APPLICATION_JSON)
    public Response getCustomerData(@PathParam("login") String login, @PathParam("password") String password, @PathParam("serialnumber") String serialnumber) { 
        return super.getFilteredMessageForSubscription( login,  password,  "IT_WHIRPOOL_STREAMS_DC_CUSTOMERDATA", "serialnumber='"+serialnumber+"'");
    }
    ...
    public Response getIssueData(@PathParam("login") String login, @PathParam("password") String password, @PathParam("serialnumber") String serialnumber) { 
        return super.getFilteredMessageForSubscription( login,  password,  "IT_WHIRPOOL_STREAMS_DC_ISSUEDATA", "serialnumber='"+serialnumber+"'");
    }
    ...
    public Response getInterventData(@PathParam("login") String login, @PathParam("password") String password, @PathParam("serialnumber") String serialnumber) { 
        return super.getFilteredMessageForSubscription( login,  password,  "IT_WHIRPOOL_STREAMS_DC_INTERVENTDATA", "serialnumber='"+serialnumber+"'");
    }
    ...
    public Response getProductData(@PathParam("login") String login, @PathParam("password") String password, @PathParam("serialnumber") String serialnumber) { 
        return super.getFilteredMessageForSubscription( login,  password,  "IT_WHIRPOOL_STREAMS_DC_PRODUCTDATA", "serialnumber='"+serialnumber+"'");
    }
